...
class CPU:
	...
	def ix_a(self):
		...
		return ((self.mmu.read((i + 1) & 0xff) << 8) +
		        self.mmu.read(i)) & 0xffff
	...
	_ops = [
	    (
	        "ADC", "v", [("im", 2, [0x69], None), ("z", 3, [0x65], None),
	                     ("zx", 4, [0x75], None), ("a", 4, [0x6d], None),
	                     ("ax", 4, [0x7d], None), ("ay", 4, [0x79], None),
	                     ("ix", 6, [0x61], None), ("iy", 5, [0x71], None)]
	    ),
	    (
	        "AND", "v", [("im", 2, [0x29], None), ("z", 3, [0x25], None),
	                     ("zx", 4, [0x35], None), ("a", 4, [0x2d], None),
	                     ("ax", 4, [0x3d], None), ("ay", 4, [0x39], None),
	                     ("ix", 6, [0x21], None), ("iy", 5, [0x31], None)]
	    ),
	    (
	        "ASL", "a", [("im", 2, [0x0a], "a"), ("z", 5, [0x06], None),
	                     ("zx", 6, [0x16], None), ("a", 6, [0x0e], None),
	                     ("ax", 7, [0x1e], None)]
	    ),
	    (
	        "B", "v", [("PL", 2, [0x10], ("N", False)),
	                   ("MI", 2, [0x30], ("N", True)),
	                   ("VC", 2, [0x50], ("V", False)),
	                   ("VC", 2, [0x70], ("V", True)),
	                   ("CC", 2, [0x90], ("C", False)),
	    ...
	    ("BIT", "v", [("z", 3, [0x24], None), ("a", 4, [0x2c], None)]),
	    ("BRK", "v", [("im", 7, [0x00], 1)]),
	    (
	        "CMP", "v", [("im", 2, [0xc9], None), ("z", 3, [0xc5], None),
	                     ("zx", 4, [0xd5], None), ("a", 4, [0xcd], None),
	                     ("ax", 4, [0xdd], None), ("ay", 4, [0xd9], None),
	                     ("ix", 6, [0xc1], None), ("iy", 5, [0xd1], None)]
	    ),
	    (
	        "CPX", "v", [("im", 2, [0xe0], None), ("z", 3, [0xe4], None),
	                     ("a", 4, [0xec], None)]
	    ),
	    (
	        "CPY", "v", [("im", 2, [0xc0], None), ("z", 3, [0xc4], None),
	                     ("a", 4, [0xcc], None)]
	    ),
	    (
	        "DEC", "a", [("z", 5, [0xc6], None), ("zx", 6, [0xd6], None),
	                     ("a", 6, [0xce], None), ("ax", 7, [0xde], None)]
	    ),
	    ("DEX", "a", [("im", 2, [0xca], 1)]),
	    ("DEY", "a", [("im", 2, [0x88], 1)]),
	    (
	        "EOR", "v", [("im", 2, [0x49], None), ("z", 3, [0x45], None),
	                     ("zx", 4, [0x55], None), ("a", 4, [0x4d], None),
	                     ("ax", 4, [0x5d], None), ("ay", 4, [0x59], None),
	                     ("ix", 6, [0x41], None), ("iy", 5, [0x51], None)]
	    ),
	    (
	        "CL", "v", [("C", 2, [0x18], "C"), ("I", 2, [0x58], "I"),
	                    ("V", 2, [0xb8], "V"), ("D", 2, [0xd8], "D")]
	    ),
	    (
	        "SE", "v", [("C", 2, [0x38], "C"), ("I", 2, [0x78], "I"),
	                    ("D", 2, [0xf8], "D")]
	    ),
	    (
	        "INC", "a", [("z", 5, [0xe6], None), ("zx", 6, [0xf6], None),
	                     ("a", 6, [0xee], None), ("ax", 7, [0xfe], None)]
	    ),
	    ("INX", "a", [("im", 2, [0xe8], 1)]),
	    ("INY", "a", [("im", 2, [0xc8], 1)]),
	    ("JMP", "a", [("a", 3, [0x4c], None), ("i", 5, [0x6c], None)]),
	    ("JSR", "a", [("a", 6, [0x20], None)]),
	    (
	        "LDA", "v", [("im", 2, [0xa9], None), ("z", 3, [0xa5], None),
	                     ("zx", 4, [0xb5], None), ("a", 4, [0xad], None),
	                     ("ax", 4, [0xbd], None), ("ay", 4, [0xb9], None),
	                     ("ix", 6, [0xa1], None), ("iy", 5, [0xb1], None)]
	    ),
	    (
	        "LDX", "v", [("im", 2, [0xa2], None), ("z", 3, [0xa6], None),
	                     ("zy", 4, [0xb6], None), ("a", 4, [0xae], None),
	                     ("ay", 4, [0xbe], None)]
	    ),
	    (
	        "LDY", "v", [("im", 2, [0xa0], None), ("z", 3, [0xa4], None),
	                     ("zx", 4, [0xb4], None), ("a", 4, [0xac], None),
	                     ("ax", 4, [0xbc], None)]
	    ),
	    (
	        "LSR", "a", [("im", 2, [0x4a], "a"), ("z", 5, [0x46], None),
	                     ("zx", 6, [0x56], None), ("a", 6, [0x4e], None),
	                     ("ax", 7, [0x5e], None)]
	    ),
	    (
	        "NOP",
	    ...
	    (
	        "ORA", "v", [("im", 2, [0x09], None), ("z", 3, [0x05], None),
	                     ("zx", 4, [0x15], None), ("a", 4, [0x0d], None),
	                     ("ax", 4, [0x1d], None), ("ay", 4, [0x19], None),
	                     ("ix", 6, [0x01], None), ("iy", 5, [0x11], None)]
	    ),
	    (
	        "P", "a", [
	            ("PHA", 3, [0x48], ("PH", "a")),
	    ...
	    (
	        "ROL", "a", [("im", 2, [0x2a], "a"), ("z", 5, [0x26], None),
	                     ("zx", 6, [0x36], None), ("a", 6, [0x2e], None),
	                     ("ax", 7, [0x3e], None)]
	    ),
	    (
	        "ROR", "a", [("im", 2, [0x6a], "a"), ("z", 5, [0x66], None),
	                     ("zx", 6, [0x76], None), ("a", 6, [0x6e], None),
	                     ("ax", 7, [0x7e], None)]
	    ),
	    ("RTI", "a", [("im", 6, [0x40], 1)]),
	    ("RTS", "a", [("im", 6, [0x60], 1)]),
	    (
	        "SBC", "v", [("im", 2, [0xe9, 0xeb], None), ("z", 3, [0xe5], None),
	                     ("zx", 4, [0xf5], None), ("a", 4, [0xed], None),
	                     ("ax", 4, [0xfd], None), ("ay", 4, [0xf9], None),
	                     ("ix", 6, [0xe1], None), ("iy", 5, [0xf1], None)]
	    ),
	    (
	        "STA", "a", [("z", 3, [0x85], None), ("zx", 4, [0x95], None),
	                     ("a", 4, [0x8d], None), ("ax", 5, [0x9d], None),
	                     ("ay", 5, [0x99], None), ("ix", 6, [0x81], None),
	                     ("iy", 6, [0x91], None)]
	    ),
	    (
	        "STX", "a", [
	    ...
	    (
	        "STY", "a", [("z", 3, [0x84], None), ("zx", 4, [0x94], None),
	                     ("a", 4, [0x8c], None)]
	    ),
	    # ***Ilegal Opcodes***
	    ("AAC", "v", [("im", 2, [0x0b, 0x2b], None)]),
	    (
	        "AAX", "a", [
	            ("z", 3, [0x87], None),
	            ("zy", 4, [0x97], None),
	    ...
	    ("ARR", "v", [("im", 2, [0x6b], None)]),
	    ("ASR", "v", [("im", 2, [0x4b], None)]),
	    ("ATX", "v", [("im", 2, [0xab], None)]),
	    ("AXA", "a", [("ay", 5, [0x9f], None), ("iy", 6, [0x93], None)]),
	    ("AXS", "v", [("im", 2, [0xcb], None)]),
	    (
	        "DCP", "a", [("z", 5, [0xc7], None), ("zx", 6, [0xd7], None),
	                     ("a", 6, [0xcf], None), ("ax", 7, [0xdf], None),
	                     ("ay", 7, [0xdb], None), ("ix", 8, [0xc3], None),
	                     ("iy", 8, [0xd3], None)]
	    ),
	    (
	        "ISC", "a", [("z", 5, [0xe7], None), ("zx", 6, [0xf7], None),
	                     ("a", 6, [0xef], None), ("ax", 7, [0xff], None),
	                     ("ay", 7, [0xfb], None), ("ix", 8, [0xe3], None),
	                     ("iy", 8, [0xf3], None)]
	    ),
	    (
	        "KIL", "v", [(
	    ...
	    ("LAR", "v", [("ay", 4, [0xbb], None)]),
	    (
	        "LAX", "v", [("z", 3, [0xa7], None), ("zy", 4, [0xb7], None),
	                     ("a", 4, [0xaf], None), ("ay", 4, [0xbf], None),
	                     ("ix", 6, [0xa3], None), ("iy", 5, [0xb3], None)]
	    ),
	    (
	        "RLA", "a", [("z", 5, [0x27], None), ("zx", 6, [0x37], None),
	                     ("a", 6, [0x2f], None), ("ax", 7, [0x3f], None),
	                     ("ay", 7, [0x3b], None), ("ix", 8, [0x23], None),
	                     ("iy", 8, [0x33], None)]
	    ),
	    (
	        "RRA", "a", [("z", 5, [0x67], None), ("zx", 6, [0x77], None),
	                     ("a", 6, [0x6f], None), ("ax", 7, [0x7f], None),
	                     ("ay", 7, [0x7b], None), ("ix", 8, [0x63], None),
	                     ("iy", 8, [0x73], None)]
	    ),
	    (
	        "SLO", "a", [("z", 5, [0x07], None), ("zx", 6, [0x17], None),
	                     ("a", 6, [0x0f], None), ("ax", 7, [0x1f], None),
	                     ("ay", 7, [0x1b], None), ("ix", 8, [0x03], None),
	                     ("iy", 8, [0x13], None)]
	    ),
	    (
	        "SRE", "a", [("z", 5, [0x47], None), ("zx", 6, [0x57], None),
	                     ("a", 6, [0x4f], None), ("ax", 7, [0x5f], None),
	                     ("ay", 7, [0x5b], None), ("ix", 8, [0x43], None),
	                     ("iy", 8, [0x53], None)]
	    ),
	    ("SXA", "a", [("ay", 5, [0x9e], None)]),
	    ("SYA", "a", [("ax", 5, [0x9c], None)]),
	    ("XAA", "v", [("im", 2, [0x8b], None)]),
	    ("XAS", "a", [("ay", 5, [0x9b], None)])
	]
	...
	def ROR(self, a):
		if a == "a":
			v_old = self.r.a
			self.r.a = v_new = ((v_old >> 1) +
			                    self.r.getFlag('C') * 0x80) & 0xff
		else:
			v_old = self.mmu.read(a)
